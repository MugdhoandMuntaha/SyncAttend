...
import { GraduationCap, LayoutDashboard, BookOpen, Clock, BarChart3, LogOut, Menu, X, UserPlus } from 'lucide-react'
...
const navLinks = [
  ...
  { href: '/teacher/session/new', label: 'Start Session', icon: Clock },
  { href: '/teacher/enroll', label: 'Enroll Students', icon: UserPlus },
